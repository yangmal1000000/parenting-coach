...
export const UI: Record<Language, UIStrings> = {
  en: {
    ...
    noSaved: "No saved advice yet. Tap the bookmark on advice you want to keep.",
  ...
  ko: {
    ...
    savedAdvice: "저장된 조언",
    noSaved: "저장된 조언이 없습니다. 유용한 조언에 북마크를 눌러 저장하세요.",
    viewFull: "전체 조언 보기 →",
    childProfile: "아이 프로필",
    childName: "이름 / 별명",
    childAge: "나이",
