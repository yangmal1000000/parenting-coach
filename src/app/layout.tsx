...
export const metadata: Metadata = {
  metadataBase: new URL(process.env.NEXT_PUBLIC_URL || "https://parenting-coach-two.vercel.app"),
};
  ...
  return (
    ...
    >
      <head>
        ...
        <meta name="apple-mobile-web-app-title" content="ParentKin" />
        ...
        <meta property="og:title" content="ParentKin — AI Parenting Coach" />
        ...
        <meta property="og:url" content="https://parentkin.com" />
        {/* Twitter */}
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="ParentKin — AI Parenting Coach" />
